...
public class ViewProductDetailJPanel extends javax.swing.JPanel 
{
    ...
    private void initComponents() {
        ...
        UploadImage.setText("Update Image");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        saveFeatures () ;
        txtName.setEditable (false) ; txtPrice.setEditable(false) ; btnSave.setEnabled(false) ; tblFeatures.setEnabled (false) ; btnAddFeature.setEnabled(false) ; btnRemoveFeature.setEnabled(false) ;
    ...
    if (returnValue == JFileChooser.APPROVE_OPTION) {
        ...
        // Assuming the product class has a method to set image path
        product.setImagePath(selectedFile.getAbsolutePath());
    ...
    String imagePath = product.getImagePath(); // Assuming you have a method to get image path
    if (imagePath != null && !imagePath.isEmpty()) {
        ImageIcon icon = new ImageIcon(imagePath);
        Image img = icon.getImage(); // Transform it
        Image newimg = img.getScaledInstance(150, 150, java.awt.Image.SCALE_SMOOTH); // Resize
        icon = new ImageIcon(newimg); // transform back
        imgLogo.setIcon(icon);
    } else {
        imgLogo.setIcon(null); // Or set a default image/icon if the path is not available
    }
    }
    ...
    if (imagePath != null && !imagePath.isEmpty()) {
        ...
        Image img = icon.getImage().getScaledInstance(imgLogo.getWidth(), imgLogo.getHeight(), Image.SCALE_SMOOTH);
        imgLogo.setIcon(new ImageIcon(img));
    } else {
        imgLogo.setIcon(null); // or set a default image
    }
    }
